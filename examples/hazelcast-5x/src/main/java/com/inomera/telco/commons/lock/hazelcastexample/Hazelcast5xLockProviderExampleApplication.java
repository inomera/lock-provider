...
public class Hazelcast5xLockProviderExampleApplication {
    private static final String HZ_INSTANCE_NAME = "hazelcast-5x-lock-provider-example-instance";

    public static void main(String[] args) {
        SpringApplication.run(Hazelcast5xLockProviderExampleApplication.class, args);
    }
